...
- **Dual Audio Output (Operator + Proyeksi)**:
  - Instrumen musik akan diputar secara **simultan (paralel)** baik di PC operator (untuk _monitoring_ di meja operator) maupun di layar proyeksi utama (Live Output / _sound system_ jemaat).
