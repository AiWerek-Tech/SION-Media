...
Implementasi v6 mengubah alur **Library Mode (Player-First)** dari pola _split-pane_ (list + sidebar 400px) menjadi **Full-Width Immersive Lyrics Player overlay** yang menutupi seluruh area kerja.
...
- `LibraryLyricsViewer` direfaktor menjadi komponen overlay immersive (100vw/100vh) dan menjadi _single source_ untuk interaksi lyrics di Library Mode.
