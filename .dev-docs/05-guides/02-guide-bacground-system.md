...
4.  **Thumbnail Picker**: Jika menggunakan _Asset Library_, sistem akan menampilkan grid thumbnail. Anda dapat memfilter berdasarkan koleksi atau menggunakan fitur pencarian cepat.
...
- **Otomatisasi**: Saat lagu diklik dari Playlist, visual akan berubah secara otomatis dengan transisi halus (_cross-fade_).
...
- **Resolusi**: Rekomendasi 1080p (1920x1080). Engine akan otomatis melakukan _scaling_ (cover fit) jika aspek rasio berbeda.
- **Storage**: SION-Media melakukan _indexing_ terhadap lokasi file. Sangat disarankan untuk menyimpan folder Media Library di drive internal SSD yang cepat.
