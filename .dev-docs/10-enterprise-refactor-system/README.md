...
The following documents from `.dev-docs/05-guides/` have been reorganized into this system:
...
**Original files in `.dev-docs/05-guides/` remain as-is for backward compatibility.**  
...
7. Create implementation log in .dev-docs/04-implementation/
```
