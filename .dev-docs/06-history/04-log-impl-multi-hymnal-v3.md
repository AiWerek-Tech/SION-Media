...
- **HymnalSidebar.tsx**: Sidebar kiri yang _collapsible_ (w-16 ke w-56) dengan animasi Framer Motion. Mendukung badge buku dengan warna aksen unik.
...
- **SongCard.tsx**:
  - Implementasi _Action Affordance_: Ikon aksi tampil 20% opacity saat idle dan 100% saat hover/focus.
