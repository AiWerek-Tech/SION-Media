...
### Phase 0 — Plan
- Created `/.docs/plan-onboarding-v5.md` detailing 3-phase onboarding flow, store schema, and file modifications.
...
- [x] Tombol "Get Started" mengarahkan ke pemilihan tema dan mode tanpa *flicker*.
