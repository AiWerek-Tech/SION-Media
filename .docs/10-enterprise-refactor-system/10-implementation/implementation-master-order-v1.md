...
- `.docs/10-enterprise-refactor-system/` — this documentation system
...
STEP 7 — INTEGRATE
  ...
  Create implementation log in .docs/04-implementation/
```
...
AFTER EVERY PHASE:
  ...
  □ Create implementation log in:
    .docs/04-implementation/[N]-log-impl-[feature].md
...
AFTER ARCHITECTURE DECISION:
  □ Create ADR in:
    .docs/10-enterprise-refactor-system/08-governance/
