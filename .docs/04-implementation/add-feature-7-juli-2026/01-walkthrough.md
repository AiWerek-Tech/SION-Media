...
- **[MODIFY] [src/renderer/src/store/usePlaylistStore.ts](file:///d:/my_dev/SION-Media/sion-media-desktop/src/renderer/src/store/usePlaylistStore.ts):** Menambahkan *action* `addMediaToPlaylist` untuk menyisipkan item media lokal ke rundown aktif.
...
4. Di panel kanan bawah, Anda akan melihat tab baru bernama **Media** di sebelah tab *Lagu*, *Alkitab*, dan *Info*.
